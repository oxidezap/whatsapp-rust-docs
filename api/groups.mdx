...
<Tip>
The public group surface is split into three, purpose-built views. Pick based on what you're doing with the result:
...
Routing snapshots used by the send path (the old `GroupInfo` cache) are now internal — you never call them directly. Sending a message consults them for you.
</Tip>
